...
const OverlayDemo = () => {
    ...
    const confirmationDialogFooter = (
        <>
            ...
            <Button type="button" label="Evet" icon="pi pi-check" onClick={() => setDisplayConfirmation(false)} text autoFocus />
        </>
    );
            ...
            <div className="grid">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <div>
                                ...
                                <OverlayPanel ref={op2} appendTo={typeof window !== 'undefined' ? document.body : null} showCloseIcon id="overlay_panel" style={{ width: '450px' }}>
                                    <DataTable showGridlines value={products} selection={selectedProduct || undefined} onSelectionChange={onSelectionChange} selectionMode="single" responsiveLayout="scroll" paginator rows={5} onRowSelect={onProductSelect}>
                ...
                <div className="col-12 lg:col-6">
                    ...
                    <div className="card">
                        <h5>ConfirmPopup</h5>
                        <ConfirmPopup />
                        <Button onClick={confirm} icon="pi pi-check" label="Onayla"></Button>
                    </div>
                </div>
            </div>
        </>
