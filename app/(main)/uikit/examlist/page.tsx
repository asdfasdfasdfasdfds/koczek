...
const TableDemo = () => {
    ...
    const statusFilterTemplate = (options: ColumnFilterElementTemplateOptions) => {
        return <Dropdown value={options.value} onChange={(e) => options.filterCallback(e.value, options.index)} itemTemplate={statusItemTemplate} placeholder="Select a Status" className="p-column-filter" showClear />;
    };
    ...
    const rowExpansionTemplate = (data: Demo.Product) => {
        return (
            <div className="orders-subtable">
                ...
                <DataTable showGridlines value={data.orders} responsiveLayout="scroll">
    ...
    //Öğrenciler Filtreye göre sıralanıyor.
    return (
        
           //buraya seçilen denemeye göre liste gelecek.          
            ...
            <div className="col-12">
                ...
                <h5>Deneme Seçiniz</h5>
                    ...
                    <DataTable
                        ...
                        header={header1}
                    >
                        <Column field="name" header="İsim" filter filterPlaceholder="İsme göre ara"  />
                        <Column field="name" header="Sınıf" filter filterPlaceholder="Sınıfa göre ara"  body={balanceBodyTemplate}/>
                        <Column header="Son Giriş" filterField="date" dataType="date"  body={dateBodyTemplate} filter filterElement={dateFilterTemplate} />
                        <Column field="activity" header="Başarı Oranı" showFilterMatchModes={false}  body={statusBodyTemplate} filter filterElement={activityFilterTemplate} />
                        <Column field="activity" header="Çalışma Süresi" showFilterMatchModes={false}  body={activityBodyTemplate} filter filterElement={activityFilterTemplate} />
